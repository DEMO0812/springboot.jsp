...
public class HomeController {
	...
	// load sản phẩm index
	@RequestMapping("/")
	public String homeIndex(Model model, HttpSession session, @RequestParam(defaultValue = "0") int page) {
		// Số sản phẩm trên mỗi trang
		int pageSize = 10; // Bạn có thể điều chỉnh kích thước trang theo ý muốn
