...
import edu.poly.repositories.SanPhamDanhMucRepository;
...
public class SanPhamServiceImpl implements SanPhamService {
    ...
    @Autowired
	SanPhamDanhMucRepository spDanhMucRepository;
	...
	@Override
	public List<SanPhams> findByDanhMucCon_IdDMC(int idDMC) {
		List<Integer> idDmcList = spDanhMucRepository.getIdSPByIdDMC(idDMC);
		System.out.println(idDmcList.toString());
		return spRepository.findByIdSPIn(idDmcList);
	}

	@Override
	public List<SanPhams> findAllByTenSPContaining(String string) {
		 return spRepository.findAllByTenSPContaining(string);
	}
