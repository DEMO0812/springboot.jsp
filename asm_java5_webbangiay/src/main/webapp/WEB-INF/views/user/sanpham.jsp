												...
												<div class="single_product">
													<div class="product_thumb">
														<a href="/ctSanPham/${sanPham.idSP}"><img
															src="<c:out value='images/products/${sanPham.img}' />"
															alt="" /></a>

														<div class="product_action">
															<a href="/add-to-cart?maSanPham=${sanPham.idSP}"> <i class="fa fa-shopping-cart"></i> Thêm
																sản phẩm
															</a>
														</div>
													</div>
													...
													<div class="product_info">
														<ul>
															...
															<li><a href="#" data-toggle="modal"
																data-target="#modal_box" title="Xem nhanh">Xem sản
																	phẩm</a></li>
														</ul>
													</div>
												</div>
