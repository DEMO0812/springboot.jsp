							...
							<div class="product_tab fix">
								...
								<div class="tab-content produc_tab_c">
									<div class="tab-pane fade show active" id="p_tab1"
										...
										<div class="modal_img">
											<img
												src="${pageContext.request.contextPath}/images/products/${ctSanPham.img}" />
											<div class="img_icone">
						...
						<div class="col-lg-7 col-md-6">
							<div class="product_d_right">
								...
								<div class="box_quantity mb-20">
									...
									<a href="/add-to-cart?maSanPham=${ctSanPham.idSP}"
										class="add-to-cart-button"> <i class="fa fa-shopping-cart"></i>

									</a> <a href="#" title="add to wishlist"><i class="fa fa-heart"
									...
									<div class="tab-pane fade" id="reviews" role="tabpanel">
										...
										<div class="product_review_form">
											<form action="#">
												...
												<p>Địa chỉ email của bạn sẽ không được công bố. Các
